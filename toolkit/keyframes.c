...
void process_frames(AVFormatContext *fmt_ctx, AVCodecContext *video_dec_ctx, AVStream *video_stream, double start_position, double end_position, int limit, const char *output_dir);
...
void find_keyframes(const char *filename, double start_position, double end_position, int limit, const char *output_dir) {
    ...
    process_frames(fmt_ctx, video_dec_ctx, video_stream, start_position, end_position, limit, output_dir);
...
int main(int argc, char **argv) {
    ...
    find_keyframes(filename, start_position, end_position, limit, output_dir);
